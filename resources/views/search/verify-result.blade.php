...
<div class="verification-result-container">
    ...
    <div class="receipt-preview">
        <div class="receipt-header">
            ...
            <h5 class="fw-bold mb-2">M-right Digital Receipt</h5>
            ...
            <body>
                <div class="container-fluid p-4">
                    <div class="text-center mb-4">
                        <h3>M-right Digital Receipt Verification</h3>
...
This verification was generated by the M-right Digital Receipt System.
    `);
