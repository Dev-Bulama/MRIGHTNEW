...
<body>
    ...
    <!-- Footer -->
    <div class="footer">
        <p><strong>Digital Receipt Verification:</strong> Receipt #{{ $receipt->receipt_number }}</p>
        <p> You can add your phone  to M-right Antitheft portal for additional layer of security at www.mright.com.ng</p>
        <p>Generated by M-right Digital System • 
        @if($receipt->enable_antitheft)Anti-theft Protected • @endif
        Verify online at support center</p>
