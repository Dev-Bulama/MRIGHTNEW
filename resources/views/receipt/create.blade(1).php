    ...
    <div class="row mb-4">
        <div class="col-12">
            <label class="form-label fw-medium">
                Choose Payment Method <span class="text-danger">*</span>
            </label>
            <div class="row">
                <div class="col-md-6 mb-3">
                    <div class="payment-option">
                        <input type="radio" 
                               ...
                               value="paystack" 
                               checked>
                        <label class="btn btn-outline-primary w-100 h-100 p-3" for="paystack_payment">
                            <i class="fas fa-credit-card fs-3 mb-2 d-block"></i>
                            <h6 class="fw-medium mb-1">Online Payment</h6>
                            <small class="text-warning">Pay ₦<span id="service-fee-display">{{ config('services.app.receipt_generation_fee', 500) }}</span> via Paystack</small>
                ...
                <!--               id="offline_payment" -->
                <!--               value="offline">-->
                <!--        <label class="btn btn-outline-secondary w-100 h-100 p-3" for="offline_payment">-->
