        ...
        <div class="card border-danger mt-4">
            ...
            <div class="card-body">
                <p class="text-muted mb-3">
                    Once you delete your account, all of your data will be permanently deleted. This action cannot be undone.
                </p>
            ...
            <form method="POST" action="{{ route('profile.destroy') }}">
                ...
                <div class="modal-body">
                    <div class="alert alert-warning">
                        ...
                        <strong>Important:</strong> This action will disable your account but preserve your data for record-keeping purposes.
                    </div>
                    ...
                    <ul class="text-muted mb-3">
                        ...
                        <li>Preserve all your data for reports and records</li>
                        @if($user->isShopOwner())
                            <li>Keep your shop profile for audit purposes</li>
                            <li>Maintain all generated receipts for tracking</li>
                        @endif
                        <li>Allow administrators to view your transaction history</li>
                    </ul>
                    
                    <div class="mb-3">
                        <label for="deletion_reason" class="form-label">
                            Reason for account disabling (optional):
                        </label>
                        <textarea class="form-control" 
                                  id="deletion_reason" 
                                  name="deletion_reason" 
                                  rows="3"
                                  placeholder="Please let us know why you're disabling your account..."></textarea>
                    </div>
