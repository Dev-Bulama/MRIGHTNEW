    ...
    <div class="payment-card">
        ...
        <div class="payment-methods">
            ...
            <div class="payment-method" data-method="paystack" onclick="selectPaymentMethod('paystack')">
                ...
                <p class="text-muted small mb-2">Secure payment via Paystack</p>
                <div class="badge bg-success">Instant</div>
            </div>
            ...
            <div class="payment-method" data-method="bank_transfer" onclick="selectPaymentMethod('bank_transfer')">
                ...
                <p class="text-muted small mb-2">Manual bank transfer</p>
                <div class="badge bg-warning">Manual</div>
            </div>
        </div>

        <!-- Payment Button -->
        <div class="text-center">
            <button id="payButton" class="btn btn-primary btn-lg px-5" disabled onclick="processPayment()">
                <i class="fas fa-lock me-2"></i>
                Pay ₦{{ number_format($receipt->service_fee, 2) }}
            </button>
