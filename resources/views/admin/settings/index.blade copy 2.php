                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" 
                                   ...
                                   value="{{ old('receipt_generation_fee', config('app.receipt_generation_fee', 500)) }}" 
                                   min="1"
                                   step="0.01"
                                   required>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" 
                                   ...
                                   id="resale_fee" 
                                   name="resale_fee" 
                                   value="{{ old('resale_fee', config('app.resale_fee', 300)) }}" 
                                   min="1"
                                   step="0.01"
                                   required>
                            <small class="text-muted">
                    ...
                    <div class="col-md-3">
                        <div class="border p-3 rounded text-center">
                            ...
                            <span class="text-success fw-bold fs-5">
                                ₦{{ number_format(config('app.receipt_generation_fee', 500), 2) }}
                            </span>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="border p-3 rounded text-center">
                            ...
                            <span class="text-success fw-bold fs-5">
                                ₦{{ number_format(config('app.resale_fee', 300), 2) }}
                            </span>
                        </div>
                    </div>
                    <div class="col-md-3">
