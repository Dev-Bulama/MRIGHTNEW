...
class SystemLogo extends Model
{
    ...
    /**
     * Get AMPAT logo PDF path.
     */
    public static function getAmpatLogoPdfPath(): ?string
    {
        $logo = static::getAmpatLogo();
        return $logo ? $logo->pdf_path : null;
    }

    /**
     * Get MRight logo PDF path.
     */
    public static function getMrightLogoPdfPath(): ?string
    {
        $logo = static::getMrightLogo();
        return $logo ? $logo->pdf_path : null;
    }
    ...
    public function getBase64ImageAttribute(): ?string
    {
        ...
        try {
            ...
            \Log::error('Failed to generate base64 image: ' . $e->getMessage());
            return null;
        }
    }

    /**
     * Get AMPAT logo as base64.
     */
    public static function getAmpatLogoBase64(): ?string
    {
        $logo = static::getAmpatLogo();
        return $logo ? $logo->base64_image : null;
    }

    /**
     * Get MRight logo as base64.
     */
    public static function getMrightLogoBase64(): ?string
    {
        $logo = static::getMrightLogo();
        return $logo ? $logo->base64_image : null;
    }
